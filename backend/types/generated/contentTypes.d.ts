...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'About page / hero section content';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
...
export interface ApiLedgeriaIssueLedgeriaIssue
  ...
  info: {
    description: 'Ledgeria desktop feedback (separate from portfolio content). Ingested via POST /ledgeria/v1/issues; see backend/src/ledgeria/.';
    displayName: 'Ledgeria Issue';
    pluralName: 'ledgeria-issues';
    singularName: 'ledgeria-issue';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<['bug', 'feature', 'improvement']> &
      Schema.Attribute.Required;
    clientCreatedAt: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 64;
      }>;
    ...
    lastScreen: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 2048;
      }>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ledgeria-issue.ledgeria-issue'
    > &
      Schema.Attribute.Private;
    logs: Schema.Attribute.Text;
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Technologies and skills displayed on the portfolio';
    displayName: 'Skill';
    pluralName: 'skills';
    singularName: 'skill';
  };
